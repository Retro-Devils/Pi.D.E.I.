...
elif [ "$rpi" = "2" ]; then bash $HOME/pidei/scripts/pidei-2.sh
elif [ "$rpi" = "3" ]; then bash $HOME/pidei/scripts/pidei-2.sh
elif [ "$rpi" = "4" ]; then bash $HOME/pidei/scripts/pi-dei-4.sh
else
